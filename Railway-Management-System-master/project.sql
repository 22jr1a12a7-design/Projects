...
INSERT INTO `Account` VALUES ('sasikumar','eba094d4d15bc478cdc9','sasikumar@kits.edu','Old airport road,bangalore'),('anantdadu','proxyman','dadu@cmu.ac.in','New York'),('atishay','qwerty','Atishay.jain.cse14@gnail.com','Rangmahal Mall, Panna'),('divyam310','goyal1002','divyam.goyal@gmail.com','Kota, Rajasthan'),('goku446','dejavu','goku@gmail.com','Kota, Rajasthan'),('prateek1996','ronaldoisgreat','prateek@gmail.com','New Delhi'),('user101','eba094d4d15bc478cdc9','atishay.jain.cse14@iitbhu.ac.in','Madhya Pradesh');
...
INSERT INTO `Account` VALUES ('admin','admin@1234','sasikumar@kits.edu','Old airport road,bangalore');
...
/* Find the phone number of the user whose email id is sasikumar@kits.edu */
Select Phone_no from Contact where username IN (Select Username from account where Email_id='sasikumar@kits.edu');
